...
export const demoComisionistas: Comisionista[] = [
  { id: 'com-001', nombre: 'Carlos Mendoza', tipo: 'porcentaje', valor: 2.5 },
  { id: 'com-002', nombre: 'María Fernanda López', tipo: 'porcentaje', valor: 3.0 },
  { id: 'com-003', nombre: 'José Antonio Vargas', tipo: 'fijo_kg', valor: 0.08 },
  { id: 'com-004', nombre: 'Ana Patricia Ruiz', tipo: 'porcentaje', valor: 1.8 },
  { id: 'com-005', nombre: 'Roberto Carlos Sánchez', tipo: 'fijo_kg', valor: 0.12 },
  { id: 'com-006', nombre: 'Diana Michelle Castro', tipo: 'porcentaje', valor: 2.0 },
];
...
export const demoOrdenItems: OrdenItem[] = [
  ...
  makeOrden('2026-03-20', 'OC-2026-0483', 0, 3100, 'kg', 8.6, 'com-001'),
  ...
  makeOrden('2026-04-08', 'OC-2026-0510', 4, 4500, 'kg', 4.55, 'com-005'),
  makeOrden('2026-04-10', 'OC-2026-0512', 5, 2300, 'kg', 5.85, 'com-006'),
  makeOrden('2026-04-12', 'OC-2026-0515', 6, 3000, 'kg', 7.2, 'com-001'),
  makeOrden('2026-04-15', 'OC-2026-0520', 7, 2000, 'kg', 8.1, 'com-002'),
  ...
  makeOrden('2026-05-08', 'OC-2026-0558', 4, 4000, 'kg', 4.6, 'com-001'),
